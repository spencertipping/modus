...
return ks} ) .call(this, (paths) ) ) ) ) } ) , (function(xs) {return(function(it) {return this} ) .call(this, ( (function(xs) {var x,x0,xi,xl,xr;
for(var xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] , (find(this,paths[x[0] ] ) .first() .val(x[1] ) ) ;
return xs} ) .call(this, (function(o) {var ps= [] ;
for(var k in o)Object.prototype.hasOwnProperty.call(o,k) &&ps.push( [k,o[k] ] ) ;
return ps} ) .call(this, (paths) ) ) ) ) } ) ) } } ) .call(this) ,it} ) .call(this, ( {util: {} } ) ) } ) ;
