...
//   These accept things like username/password. Right now the username component is just the identity, and password ensures that an input field is in fact a password box.

    $.modus.username() = this,
    $.modus.password() = this.attr('type', 'password')})(jQuery);
// Generated by SDoc 
